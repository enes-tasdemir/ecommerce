...
<head>
  ...
  <title>@lang('admin_ui.title') | @yield('title')</title>
  <!--favicon-->
...
<body>
  ...
  <header class="top-header">
    <nav class="navbar navbar-expand align-items-center justify-content-between gap-3">
      ...
      <ul class="navbar-nav gap-1 nav-right-links align-items-center">
        ...
        <li class="nav-item dropdown">
          <a href="javascrpt:;" class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown" aria-expanded="false">
            {!! AuthAdmin::get_photo([45,45]) !!}
          </a>
          <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
            <a class="dropdown-item  gap-2 py-2" href="javascript:;">
              <div class="text-center">
                {!! AuthAdmin::get_photo() !!}
                <h5 class="user-name mb-0 fw-bold mt-2">{{$user['name']}}</h5>
              </div>
            </a>
            <hr class="dropdown-divider">
  ...
  <aside class="mini-sidebar d-flex px-2 flex-column justify-content-between">
    <div class="sidebar-header">
      <div class="logo-icon">
        <img src="/admin_files/assets/images/logo-icon.png" class="logo-img" alt="">
      </div>
      <div class="logo-name flex-grow-1">
        <h5 class="mb-0">Metoxi</h5>
      </div>
      <div class="sidebar-close btn-toggle">
            ...
            <ul class="metismenu" id="sidenav">
              <li>
                <a href="{{route('admin.index')}}">
                  ...
                  <div class="menu-title">@lang('admin_ui.index')</div>
                </a>
              </li>
    ...
    <div class="mini-footer dark-mode">
      <a href="javascript:;" class="footer-icon dark-mode-icon" theme-change="light">
        <i class="material-icons-outlined">light_mode</i>  
      </a>
      <a href="javascript:;" class="footer-icon dark-mode-icon" theme-change="dark">
        <i class="material-icons-outlined">dark_mode</i>  
      </a>
      <a href="javascript:;" class="footer-icon dark-mode-icon" theme-change="semi-dark">
        <i class="material-icons-outlined">contrast</i>  
      </a>
      <a href="javascript:;" class="footer-icon dark-mode-icon" theme-change="bodered-theme">
        <i class="material-icons-outlined">border_style</i>
      </a>
    </div>
  </aside>
  <!--end mini sidebar-->
